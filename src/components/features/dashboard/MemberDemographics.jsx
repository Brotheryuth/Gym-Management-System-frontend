  ...
  return (
    <div className="purity-card" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div>
        ...
        <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '4px' }}>Gender & age distribution of active members.</p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        {/* Legend */}
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: '8px', marginTop: '4px', fontSize: '11px' }}>

      ...
      <aside className={`app-sidebar ${isOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-brand">
          <div style={{ display: 'flex', alignItems: 'center', flex: 1 }}>
            <img src="/logo.jpg" alt="Gym Logo" style={{ maxHeight: '48px', maxWidth: '100%', objectFit: 'contain', borderRadius: '50px'}} /> 
            <span style={{ fontSize: '18px', fontWeight: 'bold', color: 'white', marginLeft: '10px' }}>Gym Management</span>
          </div>
          {onClose && (
            <button 
              type="button" 
